...
[![PyPI](https://img.shields.io/pypi/v/cognis-portfan.svg)](https://pypi.org/project/cognis-portfan/)
[![CI](https://github.com/cognis-digital/portfan/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/portfan/actions)
...
PORTFAN exists for one job — summarize and diff nmap xml into prioritized, attackable findings — and does it without a SaaS bill or heavyweight setup.
...
```bash
portfan --version
portfan scan .                      # scan the current project
portfan scan . --format json
portfan scan . --fail-on high       # non-zero exit for CI gates
portfan mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **nmap**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`portfan` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
