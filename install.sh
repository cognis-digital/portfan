#!/usr/bin/env sh
# Universal installer for portfan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/portfan.git"
echo "Installing portfan ..."
