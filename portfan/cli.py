...
import argparse, sys
from portfan.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="portfan", description="PORTFAN — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from portfan.mcp_server import serve
        return serve()
    if args.cmd == "scan":
