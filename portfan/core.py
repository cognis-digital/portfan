"""PORTFAN core — Summarize and diff nmap XML into prioritized, attackable findings."""
...
RULES = [
    ("POR-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("POR-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("POR-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
